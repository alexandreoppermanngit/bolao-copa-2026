...
import { PrizeEstimateBox } from '@/components/PrizeEstimateBox';
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      {/*
        ...
        Hero full width, colado ao menu, com conteúdo centralizado.
      */}
      <section
      ...
      <section className="bg-white rounded-xl p-5 sm:p-6 shadow-sm">
        <h2 className="text-lg sm:text-xl font-bold mb-3">
          📋 Como funciona a pontuação — Fase de Grupos
        </h2>

        <ul className="space-y-1 text-sm sm:text-base">
          <li>
            <strong>Acertou resultado</strong> (vitória/empate/derrota):{' '}
            <strong>5 pts</strong>
          </li>
          <li>
            <strong>+ placar do time 1:</strong> +2 pts
          </li>
          <li>
            <strong>+ placar do time 2:</strong> +2 pts
          </li>
          <li>
            <strong>+ diferença de gols:</strong> +1 pt
          </li>
          <li>
            <strong>Multiplicador Zebra:</strong> até 2,0× quando o resultado foi pouco
            apostado pelos demais
          </li>
        </ul>
      </section>
      ...
      <section className="bg-white rounded-xl p-5 sm:p-6 shadow-sm border-l-4 border-brand-500">
        <h2 className="text-lg sm:text-xl font-bold mb-3">
          🥊 Pontuação na 2ª fase em diante (mata-mata)
        </h2>
        ...
        <ul className="space-y-2 text-sm sm:text-base">
          ...
          <li>
            ...
            Ex: você apostou Brasil x França nas quartas, mas Brasil x França rolou nas
            oitavas — você ainda pontua o placar do jogo.
          </li>
          <li>
          ...
          <li>
            ❌ <strong>Se o confronto apostado não aconteceu</strong> em nenhuma fase, o
            placar não pontua.
          </li>
          <li>
      ...
      {/* Classificação de seleções */}
      <section className="bg-white rounded-xl p-5 sm:p-6 shadow-sm border-l-4 border-accent-gold">
        <h2 className="text-lg sm:text-xl font-bold mb-3">
          🏅 Pontuação por seleção classificada
        </h2>

        <p className="text-sm sm:text-base mb-3 text-gray-700">
          Além dos pontos por jogos, você ganha pontos sempre que acertar uma seleção que
          avança para uma fase do mata-mata.
        </p>
        ...
        <p className="text-xs sm:text-sm mt-3 text-gray-700">
          🦓 <strong>Fator zebra de classificação:</strong> quanto mais raro for o palpite
          — ou seja, quanto menos apostadores escolheram aquela seleção — maior o
          multiplicador. Pode chegar a 2,0× quando quase ninguém acreditou.
        </p>
      </section>
...
function Card({ title, value }: { title: string; value: number }) {
  return (
    <div className="bg-white rounded-xl p-5 shadow-sm">
      <div className="text-sm sm:text-base text-gray-600">{title}</div>
      <div className="text-3xl sm:text-4xl font-bold text-brand-600 mt-2">
        {value}
      </div>
    </div>
  );
